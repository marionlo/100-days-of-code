...
**Today's Progress**: I've listened to a couple of podcasts (mostly on Javascript) and did some katas.
...
**Thoughts:** Need to had the hover effect on each project with details tomorrow! 
...
**Today's Progress**: Added the tablet landscape responsive mode of my portfolio, nearly done with responsive.

**Thoughts:** Need to add the favicon and apple touch image.
