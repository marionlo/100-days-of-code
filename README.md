...
**Today's Progress**: I've continued the brick breaker game in Javascript, started to add the event listener for the key input to control the platform. Practiced a little bit PHP as well with some exercices, and learnt about the if statement.
